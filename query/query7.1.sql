SELECT a.nome, a.partita_iva, st.posizione_lavorativa, COUNT(codice_rs) AS numero_recensioni_stipendio,
...
GROUP BY a.nome, a.partita_iva, st.posizione_lavorativa;
